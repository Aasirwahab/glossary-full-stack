            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
                ...
                <div className="text-center md:text-left">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                        <a href="/products" className="px-6 py-3 bg-white text-green-950 font-semibold rounded-xl hover:bg-orange-100 transition-colors">Shop Now</a>
                        <a href="#" className="px-6 py-3 bg-white/10 text-white font-semibold rounded-xl hover:bg-white/20 transition-colors border border-white/20">Learn More</a>
                    </div>
                </div>
